...
import static com.example.sandeepsharma.diginehru.R.id.checkbox;
...
//        }
        if (success) {
            if (radio_type.getCheckedRadioButtonId() == R.id.radio_staff) {
                new LoginNetwork(this, AppConstants.LOGIN_NETWORK, edit_user_id.getText().toString(), false, checkbox.isChecked());
                success = true;
            } else if (radio_type.getCheckedRadioButtonId() == R.id.radio_student) {
                new LoginNetwork(this, AppConstants.LOGIN_NETWORK, edit_user_id.getText().toString(), true, checkbox.isChecked());
                success = true;
